...
//!
//! The module provides a [`TreeFormatter`] trait and a built-in [`PrettyPrinter`] implementation
//! that renders an ANSI-coloured tree to any `fmt::Write` sink.  Custom formatters can be plugged
//! in via [`ProfileStats::print_with`].
